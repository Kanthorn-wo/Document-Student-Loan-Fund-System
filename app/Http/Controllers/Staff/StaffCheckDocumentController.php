...
class StaffCheckDocumentController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('staff.checkdocument.index', compact('approve', 'req_status', 'req_row', 'faculties', 'req_faculty', 'req_year', 'file_doc', 'req_file_doc', 'data_prefix_name'));
    }
    ...
    public function all()
    {
        ...
        return view('staff.checkdocument.all', compact('send_doc'));
    }
    ...
    public function satffDisapproval(Request $request, $id)
    {
