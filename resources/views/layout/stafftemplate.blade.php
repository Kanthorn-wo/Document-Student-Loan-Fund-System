  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item {{ url()->current() == route('admin.check.approve.list')  ? 'active' : '' }}">
        <a class="nav-link "
          href="{{ route('staff.check.list',['status' => 0 , 'row' => 10 ,'faculty' => 'all','year' => $year_thai_now ,'file_doc' => $last_id]) }}">
      ...
      <li class="nav-item {{ url()->current() == route('staff.profile.index')  ? 'active' : '' }}">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item d-flex align-items-center"
                  href="{{ route('admin.check.approve.list',['status' => 0]) }}">
                  <div class="mr-3">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-danger" href="{{ route('staff.logout') }}">ออกจากระบบ</a>
        </div>
      </div>
    </div>
  </div>
