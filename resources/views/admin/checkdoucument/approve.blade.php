        ...
        <div class="row d-flex justify-content-between">
          ...
          <div class=" col-sm ">
            <div style=" display: flex; float: right;">
              ...
              <form action="{{ route('admin.check.approve.list') }}" method="get">
                <div class="d-flex">
                  ...
                  <div class="modal-dialog  modal-xl modal-dialog-scrollable">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <a href="{{ route('admin.check.approve', ['id' => $row->id]) }}" type="button"
                        ...
                        <div class="modal fade" id="disapprove{{ $row->id }}" tabindex="-1"
                          ...
                          <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form action="{{ url('admin/checkdocument/disapproval/'.$row->id) }}" method="post"
                                  id="form-comment">
                                  @csrf
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-3">
                              <div class="form-group focused">
                                ...
                                <input type="text" id="first_name" class="form-control" name="" placeholder="" readonly
                                  value="{{ old('first_name', $row->user->first_name) }}">
                              </div>
                            </div>
                            <div class="col-lg-3">
                              <div class="form-group focused">
                                <label class="form-control-label" for="last_name">นามสกุล</label>
                                <input type="text" id="last_name" class="form-control" name="" placeholder="" readonly
                                  value="{{ old('last_name', $row->user->last_name) }}">
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="form-group focused">
                                ...
                                <input type="text" id="student_id" class="form-control" name="" placeholder="" readonly
                                  value="{{ old('student_id', $row->user->personal_id) }}">
                              </div>
                            </div>
                            <div class="col-lg-4">
                              <div class="form-group focused">
                            ...
                            <div class="col-lg-3">
                              <div class="form-group focused">
                                ...
                                <select id="year" class="form-control" name="year" value="">
                                  <option value="{{ $year1 }}" {{ $row->year === $year1 ? 'selected' : '' }}>{{ $year1
                                    }}
                                  </option>
                                  <option value="{{ $year2 }}" {{ $row->year === $year2 ? 'selected' : '' }}>{{ $year2
                                    }}
                                  </option>
                                  <option value="{{ $year3 }}" {{ $row->year === $year3 ? 'selected' : '' }}>{{ $year3
                                    }}
                                  </option>
                                </select>
                              </div>
                            ...
                            <div class="col-lg-12">
                              <div class="form-group focused">
                                <label class="form-control-label" for="img">อัพโหลดไฟล์<span
                                    class="small text-danger">*ไฟล์ที่อัพโหลดจะต้องรวมเป็น pdf ไฟล์เดียวขนาดไม่เกิน 10
                                    MB
                                    เท่านั้น</span></label>
