      ...
      <div class="card-header py-3">
        <div class="row d-flex justify-content-between">
          <div class="col-sm d-flex align-items-center">
            <a href="{{ route('admin.manage.user.list') }}" class="d-flex">
              <h6 class="m-0 font-weight-bold text-primary ">จัดการผู้ใช้ในระบบ</h6>
              <h6 class="m-0 font-weight-bold text-primary ml-1 mr-1"> / </h6>
              <h6 class="m-0 font-weight-bold text-primary ">นักศึกษา</h6>
            </a>
            <h6 class="m-0 font-weight-bold text-secondary ml-1 mr-1">/</h6>
            <h6 class="m-0 font-weight-bold text-secondary ">ค้นหา</h6>
